 ...
 *
 * Valori in EUR — fascia mercato secondario condizioni buone (2024-2026).
 ...
 *
 * ═══════════════════════════════════════════════════════════════
 * STRATEGIA INVESTIMENTO — "il vintage come un'azione" (giu 2026)
 * Sei voci di bilancio: 1) calibro = il motore (colonne > camme,
 * manifattura > ébauche); 2) rarità = il flottante (meno di 10 in
 * vendita = stretto); 3) storia documentabile = bilancio certificato;
 * 4) pavimento = oro/melt o acciaio sportivo richiesto; 5) liquidità;
 * 6) CATALIZZATORE = rilancio/acquisizione/riedizione/libro. Comprare
 * PRIMA del catalizzatore (precedente: Universal Genève → Breitling
 * 2023, Compax raddoppiati). Strategia famiglia: quando il capofamiglia
 * esplode (Sherpa Graph), compra i fratelli fermi (Divette/Jet/Guide).
 * ═══════════════════════════════════════════════════════════════
 */
...
const VINTAGE_DB = {
  ...
  'omega f300 diapason': { brand:'Omega', model:'Electronic f300 Hz (diapason)', caliber:'ESA 9162 (diapason)', years:'1970s', material:'acciaio / oro cappato', valueLow:200, valueHigh:500, desirability:6, sleeper:true, note:'Nicchia tecnica diapason con club fedele, prezzi fermi da anni: downside quasi nullo, upside se la nicchia si scalda (vedi Accutron Spaceview). Comprare SOLO funzionanti: pochi riparatori.' },
  ...
  'movado kingmatic': { brand:'Movado', model:'Kingmatic / Calendomatic pre-quarzo', caliber:'cal. M90/manifattura', years:'1940s-60s', material:'acciaio / oro', valueLow:300, valueHigh:600, desirability:6, sleeper:true, note:'INVESTIMENTO: manifattura vera e storia enorme a prezzo da brand "rovinato" dal quarzo. I crono M95 sono già cari, Kingmatic e calendari ancora fermi: titolo sottovalutato classico.' },
  ...
  'universal geneve compax': { brand:'Universal Genève', model:'Compax / Tri-Compax', caliber:'cal. 281/287/481', years:'1940s-60s', material:'acciaio / oro', valueLow:3000, valueHigh:15000, desirability:9, grail:true, note:'Cronografi splendidi. Tri-Compax in oro = valori molto alti. Brand in piena riscoperta: il caso-scuola del catalizzatore (acquisita da Breitling 2023, prezzi raddoppiati).' },
  ...
  'doxa sub 300': { brand:'Doxa', model:'SUB 300 "Black Lung"', caliber:'cal. ETA', years:'1967-1970s', material:'acciaio', valueLow:3000, valueHigh:10000, desirability:8, grail:true, note:'Diver arancione iconico. Cousteau. ATTENZIONE: i SUB veri vintage sono SOLO 1967-1975 (plexi, lunetta no-deco alluminio). Il SUB 200 è una linea SOLO MODERNA e le riedizioni dal 2002 citano apposta il 1967: NON sono vintage.' },
  ...
  'tissot pr516 vintage': { brand:'Tissot', model:'PR516 / sportivo racing', caliber:'cal. 782/2481 / Lemania', years:'1960s-70s', material:'acciaio', valueLow:400, valueHigh:900, desirability:6, sleeper:true, note:'INVESTIMENTO: design racing con fori da volante, calibri solidi, DNA Lemania nei crono. Il fratello povero dello Speedmaster a 1/10. Salita lenta ma costante.' },
  ...
  'wittnauer chrono vintage': { brand:'Wittnauer', model:'Professional Chronograph vintage', caliber:'cal. Valjoux 72', years:'1950s-60s', material:'acciaio', valueLow:2000, valueHigh:7000, desirability:7, sleeper:true, note:'INVESTIMENTO: STESSO Valjoux 72 di Heuer e Daytona pre-oro, marchio sorella di Longines. L\'Heuer equivalente fa 4 volte tanto: sconto enorme su fondamentali identici. Il mercato USA li sta scoprendo.' },
  ...
  'nivada antarctic': { brand:'Nivada Grenchen', model:'Antarctic', caliber:'auto ETA', years:'1950s-60s', material:'acciaio', valueLow:500, valueHigh:1800, desirability:7, sleeper:true, note:'INVESTIMENTO: marchio GIÀ rilanciato (2020), le riedizioni fanno pubblicità agli originali. I Chronomaster sono già saliti, Antarctic e Depthmaster ancora indietro: compra i fratelli fermi.' },
  ...
  'gallet multichron': { brand:'Gallet', model:'MultiChron / Decimal / Yachting', caliber:'Excelsior Park 4 / Valjoux 72', years:'1940s-60s', material:'acciaio', valueLow:1500, valueHigh:6000, desirability:8, sleeper:true, note:'INVESTIMENTO: il crono dei professionisti pre-Heuer, storia militare documentatissima, flottante strettissimo. Quando si muove, si muove forte.' },
  ...
  'excelsior park chrono': { brand:'Excelsior Park', model:'Chronograph / Monte Carlo', caliber:'EP cal. 40 / 4 (manifattura)', years:'1940s-60s', material:'acciaio', valueLow:1500, valueHigh:6000, desirability:8, sleeper:true, note:'INVESTIMENTO: MANIFATTURA pura di cronografi (faceva i motori per Gallet e GP), fallita 1983, produzione minuscola. Una Universal Genève in miniatura senza ancora il compratore.' },
  ...
  'doxa sub 300t': { brand:'Doxa', model:'SUB 300T Conquistador', caliber:'ETA', years:'1960s-70s', material:'acciaio', valueLow:1500, valueHigh:5000, desirability:8, sleeper:true, note:'Diver arancione amato da Cousteau. SOLO i 1967-75 sono vintage veri (era Synchron/Aubry, plexi). SUB 200 = linea solo moderna; riedizioni 2002+ citano il 1967 per marketing: scartare.' },

  // ── ENICAR (Sherpa, spedizioni himalayane) ──
  'enicar sherpa graph': { brand:'Enicar', model:'Sherpa Graph / Sherpa Guide', caliber:'Valjoux 72 / 724', years:'1960s', material:'acciaio', valueLow:2500, valueHigh:9000, desirability:8, sleeper:true, note:'Crono e GMT da spedizione, Jim Clark lo indossava. Cult tra connoisseur. Il capofamiglia è già esploso: vedi i fratelli minori.' },
  'enicar sherpa divette jet': { brand:'Enicar', model:'Sherpa Super Divette / Jet GMT / Star', caliber:'manifattura AR / AS, casse EPSA', years:'1960s', material:'acciaio', valueLow:600, valueHigh:1500, desirability:7, sleeper:true, note:'INVESTIMENTO — strategia famiglia: lo Sherpa Graph è esploso (4000+), i fratelli (Super Divette, Jet, Guide, Star) sono ancora fermi. Manifattura vera, casse EPSA, libro dedicato già uscito = catalizzatore attivo. Compra i fratelli mentre il mercato guarda il capofamiglia.' },

  // ── VULCAIN (Cricket, sveglia, "orologio dei presidenti") ──
  'vulcain cricket': { brand:'Vulcain', model:'Cricket', caliber:'Vulcain 120 (sveglia, manifattura)', years:'1947-70s', material:'acciaio / oro / placcato', valueLow:500, valueHigh:2500, desirability:7, sleeper:true, note:'INVESTIMENTO: prima sveglia da polso affidabile, indossata dai presidenti USA. Manifattura, marchio rilanciato (2021) = catalizzatore attivo. La narrativa più raccontabile del vintage, e la narrativa vende.' },
  ...
  // ── ORIENTAL (assemblatore "Chronographe Suisse", caso Valjoux 92) ──
  'oriental chronograph valjoux': { brand:'Oriental', model:'Chronograph (Valjoux 92 / Landeron 48)', caliber:'Valjoux 92 (ruota a colonne) / Landeron 48 (camme)', years:'1940s-50s', material:'oro 18k / placcato', valueLow:900, valueHigh:2200, desirability:7, sleeper:true, note:'Assemblatore famiglia Chronographe Suisse, ponte "ORIENTAL 17 RUBIS". REGOLA: stesso layout bicompax 9-3 per entrambi i calibri — solo la foto movimento lato pulsanti decide. Torretta a castello = Valjoux 92 = 1500-2200 in oro (premio colonne). Camme = Landeron = quasi solo melt (900-1400). Anello interno marcato METAL = normale. Caso reale giu 2026: V92 oro rosa eBay 1200 = compra.' },
  ...
  'airain type 20': { brand:'Airain', model:'Type 20 / Sous-Marine', caliber:'Valjoux 22 / flyback', years:'1950s-60s', material:'acciaio', valueLow:2000, valueHigh:8000, desirability:8, sleeper:true, note:'Crono militare flyback Type 20 francese, fratello povero del Breguet Type 20. Marchio rilanciato di recente = catalizzatore attivo, originali in salita.' },
  ...
  'aquastar deepstar vintage': { brand:'Aquastar', model:'Deepstar / Benthos / 60', caliber:'Lemania 1350 / ETA', years:'1960s-70s', material:'acciaio', valueLow:1500, valueHigh:6000, desirability:8, sleeper:true, note:'Specialista subacqueo svizzero, crono diver leggendari. Marchio rinato (catalizzatore attivo), vintage molto ricercati dai conoscitori.' },
  ...
  'certina ds ph200m': { brand:'Certina', model:'DS-2 PH200M / PH500M diver', caliber:'Certina 25-65 (manifattura)', years:'1960s-70s', material:'acciaio', valueLow:300, valueHigh:1200, desirability:7, sleeper:true, note:'INVESTIMENTO — caso catalizzatore da manuale: il PH200M è passato da 300 a 800-1200 dopo la riedizione. DS-2 crono e PH500M ancora umani: stessa traiettoria in corso.' },
...
// ─────────────────────────────────────────────
// FILTRO MODERNI / RIEDIZIONI (fix caso Doxa, 10/06/2026)
// L'anno NON si deduce mai da numeri vicini a calibro/ref ("cal. ETA
// 1970" non rende vintage un Doxa moderno). Qui intercettiamo i segnali
// INEQUIVOCABILI di moderno/riedizione PRIMA del match col database,
// così un SUB 200 nuovo non aggancia mai la scheda del SUB 300 del '67.
// Pattern volutamente conservativi: meglio lasciar passare un dubbio
// (ci pensa Claude) che scartare un vintage vero.
// ─────────────────────────────────────────────
const MODERN_PATTERNS = [
  /\b(reissue|re-?edition|riedizione|rieditat[oa]|heritage\s+edition|tribute|hommage|omaggio\s+al)\b/i,
  /\bsub\s*200\b/i,                                   // Doxa SUB 200 = linea SOLO moderna
  /\b(clive\s*cussler|sub\s*300\s*carbon|aquagraph)\b/i, // Doxa moderne riconoscibili
  /\b(nh3[456]|sw[\s-]?200|sw[\s-]?300|sellita|miyota)\b/i, // movimenti moderni
  /\b(vetro\s+zaffiro|sapphire\s+(crystal|glass)|saphirglas|lunetta\s+(in\s+)?ceramica|ghiera\s+(in\s+)?ceramica|ceramic\s+bezel)\b/i,
  /\b(brand\s*new|unworn|mai\s+indossato|nuovo\s+con\s+(scatola|garanzia)|new\s+with\s+(box|tags))\b/i,
  /\b(garanzia|warranty|gewährleistung)\s+(199[5-9]|20[0-2][0-9])\b/i,
  /\b(anno|year|del|bj\.?|baujahr)\s+(199[5-9]|20[0-2][0-9])\b/i,
  /\bfull\s*set\s+(199[5-9]|20[0-2][0-9])\b/i,
  /\blimited\s+edition\s+(20[0-2][0-9]|\d{1,4}\s*\/\s*\d{2,4})\b/i,
];
function hasModernSignals(title) {
  const t = String(title || '');
  return MODERN_PATTERNS.some(re => re.test(t));
}
...
function findVintageModel(title) {
  ...
  // FIX 10/06/2026: i moderni e le riedizioni non devono MAI matchare
  // le schede vintage (caso Doxa SUB 200 "Sharkhunter" scambiato per
  // SUB 300 Black Lung del 1967).
  if (hasModernSignals(title)) return null;
  ...
  // DOXA: doppia sicurezza. La linea SUB 200 esiste SOLO moderna:
  // qualsiasi "Doxa ... SUB 200 ..." non è roba nostra, punto.
  if (/\bdoxa\b/.test(t) && /\bsub\s*200\b/.test(t)) return null;
...
function evaluateVintageDeal(title, priceEur) {
  ...
  // GUARDIA "TROPPO BELLO PER ESSERE VERO" (10/06/2026): un grail o un
  // pezzo molto desiderato a MENO della metà del minimo di mercato è
  // quasi sempre un errore di identificazione, una riedizione o un falso.
  // Non si alerta come GRAIL: si marca "suspect" e si lascia decidere
  // a Claude (o a Leonardo) con le foto.
  const suspect = (model.grail || model.desirability >= 8) && priceEur < model.valueLow * 0.45;
  return {
    ...
    suspect,
    isDeal: priceEur < model.valueLow && !suspect,   // sotto il minimo di mercato = occasione (se non sospetto)
    isGoodDeal: priceEur < model.valueLow * 0.85 && !suspect, // 15%+ sotto minimo = ottima occasione
    isGrailDeal: (model.grail && priceEur < model.valueLow && !suspect),
  };
}

module.exports = { VINTAGE_DB, findVintageModel, evaluateVintageDeal, hasModernSignals };
