...
const BRAND_WATCHLIST = {
  ...
  'revue thommen':     { status:'in_riscoperta', studyOnly:true, tesi:'Manifattura con calibri propri. PRIMATO: primo cronografo per l\'aviazione svizzera (1916), poi strumenti di volo (altimetri). Cronografi aviazione di qualita, dimenticati.' },
