...
async function analyzeListing(title, priceEur, imageUrl) {
  ...
  const SCARTA = [
    ...
    // ── NON-OROLOGI (olandese/tedesco/francese per Marktplaats/DE) ──
    'schilderij','schilderijen','aquarium','aquaria','gemälde','ölgemälde',
    'peinture','tableau','lithografie','lithographie','gravure','tekening',
    'handtas','parfum','bril ','zonnebril',
  ];
