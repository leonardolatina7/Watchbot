...
const CATALYST_BRANDS = [
  ...
  'Cartier', 'Audemars Piguet', 'Patek Philippe', 'Jaeger-LeCoultre',
...
const CATALYST_KEYWORDS = [
  ...
  // ── Sessione Cambi 1158 (29/06/26): dress vintage oro nobile + quadranti ──
  // Cartier Paris vintage (modello Fabergé/Square Incurvée — NON è un brand a sé)
  'cartier fabergé','cartier faberge','square incurvée','square incurvee',
  'cartier paris dial','cartier 78101','cartier paris',
  // Vacheron Constantin solo-tempo oro/salmone + perpetuo ultra-thin
  'vacheron 4667','salmon dial vacheron','vacheron 43031','quantieme perpetuel',
  'cal 1120 qp','1120 qp',
  // Audemars Piguet extrapiatto vintage + calibro condiviso
  'audemars piguet 5043','ap extra-thin','calibre 2003','caliber 2003','eggly',
  // Patek Philippe Ellipse vintage
  'ellipse 3545','golden ellipse','patek ellipse',
  // Jaeger-LeCoultre ultra-thin oro
  'jlc 111.1.09','jaeger ultra thin gold',
  // Rolex Precision doppia firma rivenditore + Datejust quotato
  'rolex precision','ronchi milano','retailer signed','double signed dial',
  'doppia firma','datejust 16220',
  // Rivenditori/doppie firme italiane storiche (radar provenienza)
  'türler','turler','gobbi milano','cusi milano','hausmann roma',
  // Trend quadranti + segmento ultra-thin neo-vintage
  'pink champagne dial','tropical dial','ultra-thin perpetual','neo-vintage perpetual',
  // Platino dress vintage (prezioso ma NO melt floor liquido come l'oro)
  'platinum dress watch','pt950 case',
];
