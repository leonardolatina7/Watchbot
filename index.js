          ...
          if (metal && (metal.isArbitrage || metal.isNear)) {
            ...
            if (metalloSicuro) {
              ...
              await tg(
                ...
                `\u{1F48E} Sotto c'\u00E8 metallo per: <b>\u20AC${metal.metalValue.toLocaleString('it-IT')}</b> (${metal.pureMetalGrams}g)\n`+
                `   \u2192 questo \u00E8 il PAVIMENTO: sotto non vale\n`+
                (metal.diffPct>0
                  ? `\u{1F4C9} Gi\u00E0 <b>\u2212${metal.diffPct}% sotto il metallo</b>: affare gi\u00E0 cos\u00EC\n`
                  : `\u{1F4CA} Solo ${Math.abs(metal.diffPct)}% sopra il metallo\n`)+
                `\n\u{1F3AF} <b>Tratta col venditore.</b> Offri ~\u20AC${offerta.toLocaleString('it-IT')}: se accetta, ci guadagni \u20AC${guadagnoSeOfferta.toLocaleString('it-IT')} garantiti dal metallo.\n`+
