...
function detectMetal(t) {
  ...
  // ORO SOLO PARZIALE: ghiera/lunetta/corona/quadrante in oro, oppure
  // acciaio-oro (two-tone). NON è oro massiccio: niente paracadute metallo.
  // Riconoscere questi casi evita le segnalazioni ambigue.
  ...
  if (partialGold) return null; // trattato come NON-oro-massiccio
...
<style>
  ...
  <p class="live">Prezzo oro fino LIVE: ${goldFine} €/g</p>
