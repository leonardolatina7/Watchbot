...
// ══════════════════════════════════════════════════════════════
// Query mirate — poche e efficienti per non esaurire SerpAPI (100/mese)
// Mix: oro generico + vintage modelli specifici ad alto valore
const GOLD_QUERIES = [
  // Oro 18k generico (arbitraggio metallo)
  'orologio oro 18k',
  'montre or 18k',
  'orologio platino 950',
  // Vintage ad alto valore (occasioni collezione)
...
// ── CRON ─────────────────────────────────────────────────────
cron.schedule('0 */6 * * *',()=>runGoldScan().catch(()=>{}));
