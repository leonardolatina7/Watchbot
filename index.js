  ...
  for (const query of activeQueries) {
    try {
      const sources = mode === 'subito'
        ...
        : [
            searchMarktplaats,     // ✅ funziona
            searchSubito,          // ✅ JSON stabile
            searchChrono24RSS,     // ✅ RSS stabile
            searchEbaySerpAPI,     // ✅ eBay via SerpAPI (non bloccato)
            searchSerpAPILocal,    // ✅ Google Shopping IT
            (qq)=>searchSerpAPI(qq,'de'), // ✅ Google Shopping DE
            (qq)=>searchSerpAPI(qq,'fr'), // ✅ Google Shopping FR
            // Vinted: solo se non crasha per dimensioni
            searchVinted,
          ];
      let all = [];
