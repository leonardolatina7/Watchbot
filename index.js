...
// Flip cieco: ogni 6 ore, sfasato di 30' dallo scan oro (limiti vision Groq → VISION_BUDGET)
cron.schedule('30 */6 * * *',()=>runFlipCiecoScan().catch(e=>console.error('[FLIP CIECO]',e.message)));
