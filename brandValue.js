...
const BRANDS = {
  ...
  // -- BRITANNICI MILITARI: fondello W.W.W. + freccia (broad arrow) = Dirty Dozen --
  "vertex":      { buy:[300,1200], sell:[1200,3500], liq:"bassa", variant:"Se W.W.W. + freccia (Dirty Dozen, unico marchio UK) = grail, alto. Vertex civile vintage molto meno (150-500).", note:"Dirty Dozen, cal. 59. Verifica fondello W.W.W. e freccia." },
  "smiths":      { buy:[60,400],  sell:[250,1500], liq:"media", variant:"Militare W10 (fondello freccia) o Everest = premio (fino 2-3k). De Luxe inglese in oro = premio.", note:"Vero made-in-UK. Hillary sull Everest 1953. Mercato UK caldo." },
  "timor":       { buy:[200,900], sell:[700,2500], liq:"bassa", variant:"Se W.W.W. + freccia (Dirty Dozen) = alto. Civile/A.T.P. meno.", note:"Dirty Dozen. Verifica fondello W.W.W." },
  "grana":       { buy:[1500,6000], sell:[6000,18000], liq:"bassa", variant:"LA rarissima Dirty Dozen (~1000 pz), poi Certina. W.W.W. + freccia = colpo grosso. Verifica autenticita con MASSIMA cura: rara = falsificata.", note:"La piu preziosa del set. Pochissimi esemplari." },
  "newmark":     { buy:[150,700], sell:[700,2000], liq:"bassa", variant:"Il 6BB RAF (Valjoux 7733, fondello militare) = il pezzo. Newmark moderno (post-2018) = altro.", note:"Cronografo RAF 6BB 1980. Solo il vintage militare." },
  "cwc":         { buy:[120,600], sell:[450,2000], liq:"media", variant:"Diver Royal Navy issue (fondello freccia + numeri NATO) = alto. Il G10 quarzo vale meno (80-300).", note:"Cabot Watch Co: sostitui Hamilton per le forze UK." },
  "garrard":     { buy:[40,250],  sell:[150,700],  liq:"bassa", note:"Gioielliere della Corona, anche militari issue. Pezzi di ordinanza = premio." },
  // -- NORD EUROPA: l'unico vintage vero e Halda (raro, da nicchia) --
  "halda":       { buy:[80,500],  sell:[300,1500], liq:"bassa", variant:"SOLO l originale 1887-inizio 900 (tasca/strumenti ferroviari). Il moderno modulare (post-2009) NON e questo.", note:"Piu antico orologiaio svedese. Vintage raro." }
};
